...
<br><h4>Editar Gerente</h4><br>
   ...
   <div class="card">
       <div class="card-body">
           <form method="POST" action="{{route('gerente.update',['gerente'=>$gerente->id])}}"> 
               @method('PUT')
               @csrf
               ...
               <div class="form-group row">
                   ...
                   <div class="col-sm-6">
                       <div class="input-group mb-3">
                           ...
                           <input type="text" class="form-control @error('name') is-invalid @enderror" name="nome" value="{{$gerente->nome}}">
                       </div>
                   </div>
               </div>
               <div class="form-group row">
                   ...
                   <div class="col-sm-6">
                       <div class="input-group mb-3">
                           ...
                           <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$gerente->email}}">
                       </div>
                   </div>
               </div>
                <div class="form-group row">
                   ...
                   <div class="col-sm-6">
                       <div class="input-group mb-3">
                           ...
                           <input type="tel" class="form-control @error('email') is-invalid @enderror" name="telefone" value="{{$gerente->telefone}}">
                       </div>
                   </div>
               </div>
