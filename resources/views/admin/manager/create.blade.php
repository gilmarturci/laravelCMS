...
<br><h4>Cadastro de gerente</h4><br>
   ...
   <div class="card">
       <div class="card-body">
           <form method="POST" action="{{route('gerente.store')}}"> 
               @csrf
                 ...
                 <div class="form-group row">
                   ...
                   <div class="col-sm-6">
                       <div class="input-group mb-3">
                           ...
                           <input type="tel" class="form-control @error('email') is-invalid @enderror" name="telefone" value="{{old('telefone')}}">
                       </div>
                   </div>
               </div>
